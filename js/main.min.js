...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_todos2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SHOW_ALL = _todos.VisibilityFilters.SHOW_ALL;
	...
	function visibilityFilter() {
		...
		switch (action.type) {
			case _todos.SET_VISIBILITY_FILTER:
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
		return {
			onClick: function onClick() {
				dispatch((0, _todos.setVisibilityFilter)(ownProps.filter));
			}
		};
	};
			...
			_react2.default.createElement(
				...
				{ onSubmit: function onSubmit(e) {
						e.preventDefault();if (!input.value.trim()) {
							return;
						}dispatch((0, _todos.addTodo)(input.value));input.value = '';
					} },
